...
def disparate_mistreatment(data, pro_index, categorical_features, pri_val, unpri_val, val_copy, pri_class, non_pri_class):
    ...
    y_pred_val = list(data_copy[data_copy[:,pro_index] == val_copy, :][:,-1])
    y_val = list(data_copy[data_copy[:,pro_index] == val_copy, :][:,-2])
    #print('===>' )
    #print(y_val)
    #print(y_pred_val)
    TP = 0
